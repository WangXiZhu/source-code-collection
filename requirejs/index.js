...
;(function (global, setTimeout) {
    ...
    /**
     * 文档树中在头部添加结点，加载资源
     * 通过监听onreadystatechange或者onload/onerror事件，处理脚本加载成功/失败的情况
    ...
    // 返回当前正在解析的脚本资源。即readyState为interactive的资源
